...
~~~
$ git config --global user.name "DeepsMoseli"
$ git config --global user.email "moselim@hawaii.edu"
~~~
{: .language-bash}

Please use your own name and email address instead of Moseli's. This user name and email will be associated with your subsequent Git activity,
